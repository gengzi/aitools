...
public class JavaPsiUtils {
    ...
    private static final List<String> COMMON_QUALIFIED_PREFIXES;
...
//    }
    ...
    static {
        INVALID_JAVA_TOKENSET = TokenSet.orSet(new TokenSet[]{ElementType.ALL_LITERALS, ElementType.JAVA_COMMENT_OR_WHITESPACE_BIT_SET, JavaDocTokenType.ALL_JAVADOC_TOKENS, TokenSet.create(new IElementType[]{TokenType.WHITE_SPACE, TokenType.BAD_CHARACTER, TokenType.NEW_LINE_INDENT, TokenType.ERROR_ELEMENT})});
        PATTERN = Pattern.compile("\\s*(\\w*)\\(\\):(-?\\d*), (\\w*\\.java)\\n");
        COMMON_QUALIFIED_PREFIXES = Arrays.asList("java.", "javax.", "javafx.", "sun.", "org.apache.", "org.springframework.", "lombok.", "org.projectlombok", "org.aspectj.", "org.hibernate.", "org.junit.", "org.mockito.", "org.powermock.", "org.testng.", "org.jmock.", "org.slf4j", "ch.qos.logback", "kotlin.", "com.fasterxml.", "com.alibaba.fastjson", "org.mockito", "org.mybatis.", "io.swagger.", "io.springfox.", "com.github.swaggerdoc.", "org.springdoc.", "net.logstash.logback");
    }
}
